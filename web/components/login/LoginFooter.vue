...
<template>
  <footer class="custom-footer">
    ...
    <div class="footer-right">
      <div class="iRhAhG">
        <button class="lang-btn" @click="handleLanguageClick">
          <!-- German flag SVG -->
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480" width="20" height="15" aria-label="German Flag">
        ...
        <span direction="up" class="sc-jlZhe" :class="isUp ? 'daChsy' : 'eRtEQn'">
          <a href="https://www.weltsparen.de/" data-preferred-locale="de-de" class="sc-cwHptR jvUaCC">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.raisin.com/fi-fi/" data-preferred-locale="fi-fi" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
              <svg xmlns="http://www.w3.org/2000/svg" id="flag-icons-fi" viewBox="0 0 18 11" width="18" height="11">
                <rect width="18" height="11" fill="#fff"></rect>
                <path d="M0,5.5h18M6.5,0v11" stroke="#002F6C" stroke-width="3"></path>
              </svg>
            </div>Finnland
          </a>
          <a href="https://www.raisin.com/fr-fr/" data-preferred-locale="fr-fr" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.raisin.ie/" data-preferred-locale="en-ie" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.raisin.nl/" data-preferred-locale="nl-nl" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.weltsparen.at/" data-preferred-locale="de-at" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.raisin.com/pl-pl/" data-preferred-locale="pl-pl" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.raisin.es/" data-preferred-locale="es-es" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
          ...
          <a href="https://www.raisin.co.uk/" data-preferred-locale="en-gb" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
            ...
            </div>Vereinigtes Königreich
          </a>
          <a href="https://www.raisin.com/en-us/" data-preferred-locale="en-us" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
            ...
            </div>Vereinigte Staaten von Amerika
          </a>
          <a href="https://www.raisin.com/en/" data-preferred-locale="en" class="sc-cwHptR kPiSPr">
            <div class="sc-jEACwC coEowv">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 810 540">
                <defs>
                  <g id="eu_flag_d">
                    <g id="eu_flag_b">
                      <path id="eu_flag_a" d="M0 0v1h.5z" transform="rotate(18 3.157 -.5)"></path>
                      <use xlink:href="#eu_flag_a" transform="scale(-1 1)"></use>
                    </g>
                    <g id="eu_flag_c">
                      <use xlink:href="#eu_flag_b" transform="rotate(72)"></use>
                      <use xlink:href="#eu_flag_b" transform="rotate(144)"></use>
                    </g>
                    <use xlink:href="#eu_flag_c" transform="scale(-1 1)"></use>
                  </g>
                </defs>
                <path fill="#039" d="M0 0h810v540H0z"></path>
                <g fill="#fc0" transform="matrix(30 0 0 30 405 270)">
                  <use xlink:href="#eu_flag_d" y="-6"></use>
                  <use xlink:href="#eu_flag_d" y="6"></use>
                  <g id="eu_flag_e">
                    <use xlink:href="#eu_flag_d" x="-6"></use>
                    <use xlink:href="#eu_flag_d" transform="rotate(-144 -2.344 -2.11)"></use>
                    <use xlink:href="#eu_flag_d" transform="rotate(144 -2.11 -2.344)"></use>
                    <use xlink:href="#eu_flag_d" transform="rotate(72 -4.663 -2.076)"></use>
                    <use xlink:href="#eu_flag_d" transform="rotate(72 -5.076 .534)"></use>
                  </g>
                  <use xlink:href="#eu_flag_e" transform="scale(-1 1)"></use>
                </g>
              </svg>
            </div>Andere (EU)
          </a>
